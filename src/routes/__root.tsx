...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Upload, reorder, and render photo sequences into MP4 videos. Choose FPS, resolution, codec, and per-photo duration. Runs entirely in your browser." },
